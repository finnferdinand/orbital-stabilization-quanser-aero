...
print("-dpng", "-r600", "/Users/finnferdinandsandvand/git-sandbox/orbital-stabilization-quanser-aero/Controllers/Simulations/figures/robustified_controller.png");
...
function xdot = f(t,x,use_disturbance,parameters)
    ...
    u = alpha * kappa^2 * sign(x1) * abs(x1)^(2*alpha-1) ...
        - mu * sign(sigma) * abs(sigma)^((2*alpha-1)/alpha) ...
        + x3;
    x3dot = -eta * sign(sigma);
